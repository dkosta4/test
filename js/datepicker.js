...
(function ($) {
  ...
  DatePicker = function () {
    var ids = {},
      ...
      tpl = {
        wrapper: '<div class="datepicker"><div class="datepickerBorderT" /><div class="datepickerBorderB" /><div class="datepickerBorderL" /><div class="datepickerBorderR" /><div class="datepickerBorderTL" /><div class="datepickerBorderTR" /><div class="datepickerBorderBL" /><div class="datepickerBorderBR" /><div class="datepickerContainer" onclick="textFocus();"><table cellspacing="0" cellpadding="0"><tbody><tr></tr></tbody></table></div></div>',
        head: [
        ...
        for(var i = 0; i < options.calendars; i++) {
          ...
          while(cnt < 42) {
            ...
            if($.isArray(options.selectableDates) && options.selectableDates.length == 2) {
              ...
              /* Mithun Kumar
               * 
               *  Disabling future dates completely in this date picker
               *    */
              data.weeks[indic].days[indic2].classname.push('datepickerDisabled');
            }
